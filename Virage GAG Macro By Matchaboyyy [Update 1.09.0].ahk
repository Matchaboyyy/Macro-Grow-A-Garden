; Virage Grow a Garden Macro Virage GAG Macro By Matchaboyyy [Update 1.09.0]
...
honeyItems := ["Flower Seed Pack", "Lavender Seed", "Nectarshade Seed"
			 ...
			 , "Nectar Staff", "Honey Sprinkler", "Bee Egg"
             , "Bee Crate", "Honey Comb"
...
ShowWelcome:
    ...
    Gui, 99: Show, w788 h492 Center, Virage Grow a Garden Macro [BEE UPD] By X6MxTazerTxYark
return
...
; Baca status checkbox "Select All"
...
; Loop item madu dan tampilkan dalam dua kolom jika perlu
...
Gui, Add, Text,    x350 y360 w100 h24 +Right, 600
    ...
    Gui, Font, s9 cWhite Bold, Segoe UI
    Gui, Add, Text, x40 y200 200 h20, Extra Resources:
    ...
    Gui, Tab, 9
    Gui, Font, s9 cWhite, Segoe UI
    Gui, Add, GroupBox, x23 y50 w475 h340 c8A2D81, Help
    ...
    Gui, Show, w520 h425, Virage GAG Macro By Matchaboyyy [Update 1.09.0]
...
For index, item in selectedHoneyItems {
	...
	SendDiscordMessage(webhookURL, "Attempted to buy " . currentItem . ".")
        ...
        uiUniversal("63636363636363636363636363636363636363646464646464646064646", 0, 1)
	...
	SendDiscordMessage(webhookURL, "Attempted to buy " . currentItem . ".")
        Sleep, 150
        uiUniversal("63636361616464636363636161616464606056464", 0, 1)
    }
    else if (item = 6) {
        uiUniversal("636363636363636363636363636363636363636464646464646464646064646", 0, 1)
	...
	SendDiscordMessage(webhookURL, "Attempted to buy " . currentItem . ".")
        ...
        uiUniversal("63636363636363636363636363636363636363646464646464646464646460646", 0, 1)
	...
	SendDiscordMessage(webhookURL, "Attempted to buy " . currentItem . ".")
        ...
        uiUniversal("6363636363636363636363636363636363636364646464646464646464646464646064646", 0, 1)
	...
	SendDiscordMessage(webhookURL, "Attempted to buy " . currentItem . ".")
        ...
        uiUniversal("636363636363636363636363636363636363636464646464646464646464646464606464646", 0, 1)
	...
	SendDiscordMessage(webhookURL, "Attempted to buy " . currentItem . ".")
        ...
        uiUniversal("63636363636363636363636363636363636363646464646464646464646464646460646464646", 0, 1)
	...
	SendDiscordMessage(webhookURL, "Attempted to buy " . currentItem . ".")
        ...
        uiUniversal("6363636363636363636363636363636363636364646464646464646464646464646064646464646", 0, 1)
