; Prans Grow a Garden Macro [BIZZY BEE UPDATE]
...
DonateResponder(ctrlName) {
    ...
    if (ctrlName = "Donate100")
        Run, https://www.roblox.com/game-pass/1208264273/DONATE-ME-EXCLUSIVE
    else if (ctrlName = "Donate150")
        Run, https://www.roblox.com/game-pass/1209192661/DONATE-ME-EXCLUSIVE
    else if (ctrlName = "Donate300")
        Run, https://www.roblox.com/game-pass/1205684151/DONATE-ME-EXCLUSIVE
	else if (ctrlName = "Donate500")
        Run, https://www.roblox.com/game-pass/1206512192/DONATE-ME-EXCLUSIVE
    else if (ctrlName = "Donate1000")
        Run, https://www.roblox.com/game-pass/1208148591/DONATE-YOU-ARE-THE-KING
    else if (ctrlName = "Donate10000")
        Run, https://https://www.roblox.com/game-pass/1206917900/DONATE-YOU-ARE-THE-KING
    else
        return
...
ShowWelcome:
    ...
    Gui, 99: Show, w788 h492 Center, Prans Grow a Garden Macro [COSMETIC UPDATE]
return
...
ShowVerify:
    ...
    Gui, 2: Add, Text, x10 y10 w380 h40 Center, To use Prans's macro, you must follow Prans on Roblox.
    ...
    Gui, 2: Show,  w400 h110 Center, Prans Verification
Return
...
FollowUser:
    ; Replace ##### below with Prans’s actual Roblox numeric user‐ID
    Run, https://www.roblox.com/users/5825923697/profile
return

VerifyUser:
    if (triedVerify = 0) {
               MsgBox, 0x41030, Verification Error, Please make sure you follow Prans on Roblox, or wait around 10 seconds for the system to verify and try again.
        triedVerify := 1
    } else {
        Gui, 2: Destroy
        Gui, 99: Destroy
...
Gui, Add, Tab, x10 y10 w500 h400 vMyTab -Wrap, Seeds|Gears|Eggs|Cosmetics|Settings|Donate	
...
Gui, Add, Button, x113 y80 w70 h28 gDonate vDonate150     BackgroundF0F0F0, 150 Robux
Gui, Add, Button, x188 y80 w70 h28 gDonate vDonate300     BackgroundF0F0F0, 300 Robux
Gui, Add, Button, x188 y80 w70 h28 gDonate vDonate500     BackgroundF0F0F0, 500 Robux
Gui, Add, Button, x263 y80 w70 h28 gDonate vDonate1000    BackgroundF0F0F0,1000 Robux
...
Gui, Add, Text,    x350 y360 w100 h24 +Right, 600
    ...
    Gui, Font, s10 cWhite Bold, Segoe UI
    Gui, Add, Text, x100 y70 w200 h24, Prans
    ...
    Gui, Add, Link, x40 y244 w300 h16,  Check the <a href="https://github.com/PransRoblox/Prans-Grow-A-Garden-Macro/releases/latest">Github</a> for the latest macro updates!
    Gui, Add, Link, x40 y264 w300 h16, Watch the latest macro <a href="https://youtu.be/L6GsrZYjECY">tutorial</a> on Youtube!
  



    Gui, Show, w520 h425, Prans Grow a Garden Macro [BIZZY BEE UPDATE]
